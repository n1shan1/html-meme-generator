...
function showJoke() {
  ...
  const textContainer = document.querySelector(".joke-content");
  const newText = document.createElement("p");
  newText.textContent = randomJokeText;
...
function revealAnswers() {
  ...
  if(riddle && answer.hidden){
    ...
    alert("Answer alreasy reaveled.");
  }
  else{
    alert("There are no riddles to show answer for.");
  }
}
